...
// login as petugas, submit a fresh household via the real form
...
await page.fill('input[placeholder="Sesuai KTP"]', 'Warga Uji Coba');
const niks = page.locator('input[placeholder="99••••••••••••••"]');
await niks.nth(0).fill('3273000000009901');
await niks.nth(1).fill('3273999999009901');
await page.fill('input[placeholder="Jl. Contoh No. 1, RT/RW"]', 'Jl. Uji Coba No. 9');
await page.fill('input[placeholder="2500000"]', '1750000');
await page.fill('input[placeholder="Nama anggota"]', 'Warga Uji Coba');
await page.fill('input[placeholder="NIK anggota"]', '3273000000009901');
