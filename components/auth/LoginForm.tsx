...
export function LoginForm() {
  ...
  return (
    <>
      <h1 className="font-display text-[1.75rem] leading-tight tracking-[-0.02em] text-ink">
        Masuk ke SIGAP
      </h1>
      ...
      <form onSubmit={handleLogin} className="mt-6 flex flex-col gap-4">
        <label className="block">
          ...
          <input
            ...
            className="mt-1.5 w-full rounded border border-[var(--color-line)] bg-paper-2 px-3 py-2.5
              text-[14px] text-ink outline-none transition-colors placeholder:text-ink-4 focus:border-[var(--color-primary)]"
            value={username}
        ...
        <label className="block">
          ...
          <div className="relative mt-1.5">
            <input
              ...
              className="w-full rounded border border-[var(--color-line)] bg-paper-2 px-3 py-2.5 pr-10
        ...
        <LoadingButton type="submit" loading={loading} className="mt-2 w-full justify-center">
